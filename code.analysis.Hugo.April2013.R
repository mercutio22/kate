...
tothill.hv<-heatmap.plus(
		...
		keysize=1,
		dendrogram=c("none"),
		main = paste("Tothill; SRC only (73 probes) ",dim(tothill.src)[1],"Probes; ",dim(tothill.src)[2],"Samples"),
		#labCol=NA
		labRow=NA
)
dev.off()
...
gse6008.hv<-heatmap.plus(
		...
		keysize=1,
		dendrogram=c("none"),
		main = paste("gse6008; SRC only (73 probes) ",dim(gse6008.src)[1],"Probes; ",dim(gse6008.src)[2],"Samples"),
		#labCol=NA
		labRow=NA
)
dev.off()
...
gse7305.hv<-heatmap.plus(
		...
		keysize=1,
		dendrogram=c("none"),
		main = paste("gse7305; SRC only (73 probes) ",dim(gse7305.src)[1],"Probes; ",dim(gse7305.src)[2],"Samples"),
		#labCol=NA
		labRow=NA
)
dev.off()
...
gse7307.hv<-heatmap.plus(
		...
		keysize=1,
		dendrogram=c("none"),
		main = paste("gse7307; SRC only (73 probes) ",dim(gse7307.src)[1],"Probes; ",dim(gse7307.src)[2],"Samples"),
		#labCol=NA
		labRow=NA
)
dev.off()
